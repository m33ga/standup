...
export const seedMeetings: Meeting[] = [
  {
    ...
    completed: true,
    promised: "",
    done: "- set up the [project board](https://linear.app)\n- picked tech stack (**react**, **zustand**, tailwind v4)\n- wrote the readme",
    willDo: "- sketch the main flows\n- talk to **3 users** minimum",
  ...
  },
  {
    ...
    done: "- sketched 5 flows (3 good, 2 trash)\n- talked to **4 users** — notes in [notion](https://notion.so)",
    willDo: "- hi-fi mocks for meeting page\n- wire up groups CRUD",
    discussion:
      "- markdown inside sections: **yes, doing it**\n- dark mode in v1: **yes**",
  ...
  },
  {
    ...
    willDo: "",
    discussion:
      "**blockers:** waiting on copy from mo — pinged her on [slack](https://slack.com)",
    notes: "",
  },
  {
    id: "m4",
    ...
    completed: true,
    promised: "",
    done: "- met the team\n- walked through their current setup\n- signed NDA — copy in [drive](https://drive.google.com)",
    willDo: "- audit their dashboard\n- propose a **4-week scope**",
    discussion: "who approves scope changes? **cto only.**",
  ...
  },
  {
    ...
    completed: false,
    promised: "",
    done: "- hired **an**\n- **ry** starts next monday — [onboarding doc](https://notion.so)",
